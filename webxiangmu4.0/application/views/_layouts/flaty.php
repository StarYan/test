        ...
        <div id="navbar" class="navbar">
            ...
            <ul class="nav flaty-nav pull-right">
                ...
                <li class="user-profile">
                    <a  href="<?php echo site_url('login_controller/Login') ?>" class="user-menu">
                        <i class="icon-off"></i>
        ...
        <div class="container" id="main-container">
            ...
            <div id="sidebar" class="navbar-collapse collapse">
                ...
                <ul class="nav nav-list">
                    ...
                    <li>
                        <form target="#" method="GET" class="search-form">
                            <span class="search-pan">
                                ...
                                <input type="text" name="search" placeholder="输入流水号或者姓名..." autocomplete="off" />
                            </span>
                        </form>
                    </li>
                    <!-- END Search Form -->
                    <li >
                        <a href="<?php echo site_url('manager_controller/Nocheck')?>">
                    ...
                    <li >
                        <a href="<?php echo site_url('manager_controller/Pass')?>">
                    ...
                    <li >
                        <a href="<?php echo site_url('manager_controller/Nopass')?>">
                            <i class="icon-check-sign"></i>
                            <span>审核不合格</span>
                        </a>
                    </li>
