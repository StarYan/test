    ...
    <div class="col-md-12">
        <div class="box box-blue">
            <div class="box-title">
                ...
                <div class="box-tool">
                    <a class="btn btn-primary" href="<?php echo site_url('/news_controller/admin').'/'.$dataAdmin->id ?>"> 返回列表</a>
                </div>
            </div>
            <div class="box-content">
                <form action="<?php echo site_url('/news_controller/update').'/'.$result[0]['id'].'/'.$dataAdmin->id?>" class="form-horizontal form-bordered" method="post">
