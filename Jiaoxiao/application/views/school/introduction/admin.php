    ...
    <div class="row col-md-10 col-md-offset-1">
        <div class="col-xs-12 col-md-3">
            ...
            <ul class="nav nav-sidebar list-group" style="margin-top: 10%;">
                <li class="list-group-item active"><a href="<?php echo site_url('/school/introductionAdmin')?>"><i class="fa fa-home"></i> 驾校信息管理</a></li>
            ...
            <div class="manage-content" >
                <form id="form-login" class="login-form" action="<?php echo site_url('/school/introductionAdmin')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <textarea rows="5" maxlength="50" name="school_introduction" placeholder="驾校简介(50字内)..." class="form-control" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <textarea rows="5" name="school_address" class="form-control" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input name="school_tel" class="form-control" required>
                        </div>
                    </div>
