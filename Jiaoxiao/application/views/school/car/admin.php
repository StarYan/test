    ...
    <div class="row col-md-10 col-md-offset-1">
        <div class="col-xs-12 col-md-3">
            ...
            <ul class="nav nav-sidebar list-group" style="margin-top: 10%;">
                ...
                <li class="list-group-item active"><a href="<?php echo site_url('/school/carAdmin')?>"><i class="fa fa-car"></i> 车辆信息管理</a></li>
            ...
            <div class="manage-content" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-plus"></i> 添加车辆信息</h3>
                                <div class="box-tool">
                                    <a data-action="collapse" href="#"><i class="icon-chevron-down"></i></a>
                                </div>
                            </div>
                            <div class="box-content container" style="display: none;border: 1px solid rgba(88,177,252,.5)">
                                <form class="form-horizontal" method="post" action="<?php echo site_url('/school/carAdd')?>" enctype="multipart/form-data">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="number" class="col-sm-4 col-lg-3 control-label">车牌号码</label>
                                            <div class="col-sm-7 col-lg-8 controls">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="img" class="col-sm-4 col-lg-3 control-label">车辆图片</label>
                                            <div class="col-sm-7 col-lg-8 controls">
                                                <div class="input-group">
                                            ...
                                            <?php foreach($result as $carInfo):?>
                                                <tr>
                                                    ...
                                                    <td class="visible-md visible-lg text-center">
                                                        <div class="btn-group">
                                                            <a class="btn btn-sm show-tooltip" title="审核" href="<?php echo site_url('/school/carUpdate').'/'.$carInfo->id; ?>"><i class="icon-edit"></i></a>
