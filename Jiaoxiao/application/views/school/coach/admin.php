                    ...
                    <div class="col-md-12">
                        <div class="box" style="margin-top: 0">
                            ...
                            <div class="box-content container" style="display: none;border: 1px solid rgba(88,177,252,.5)">
                                <form class="form-horizontal" method="post" action="<?php echo site_url('/school/coachSearch')?>">
                                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <div class="box-content container" style="display: none;border: 1px solid rgba(88,177,252,.5)">
                                <form class="form-horizontal" method="post" action="<?php echo site_url('/school/coachAdd')?>" enctype="multipart/form-data">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="c_name" class="col-sm-4 col-lg-3 control-label">名字</label>
                                            <div class="col-sm-7 col-lg-8 controls">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="img" class="col-sm-4 col-lg-3 control-label">教练图片</label>
                                            <div class="col-sm-7 col-lg-8 controls">
                                                <div class="input-group">
                                            ...
                                            <?php foreach($result as $coachInfo):?>
                                                <tr>
                                                    ...
                                                    <td class="visible-md visible-lg text-center">
                                                        <div class="btn-group">
                                                            <a class="btn btn-sm show-tooltip" title="审核" href="<?php echo site_url('/school/coachUpdate').'/'.$coachInfo->id; ?>"><i class="icon-edit"></i></a>
