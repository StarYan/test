                ...
                <form action="<?php echo site_url('/school/studentUpdate').'/'.$result->id?>" class="form-horizontal" method="post" style="padding: 10px;">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="name" id="name" class="form-control" value="<?=$result->name?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="idcard" id="idcard" value="<?=$result->idcard?>" class="form-control" readonly>
                        </div>
                    </div>
